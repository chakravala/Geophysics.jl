...
const US22 = Atmosphere{Metric}(Values(-6.5e-3,0e-3),Values(-00e3,11e3))
const US25 = Atmosphere{Metric}(Values(-6.5e-3,0e-3),Values(-00e3,10.76923e3))
const US56 = Atmosphere{Metric}(
    Values(-6.5e-3,0e-3,3e-3,0e-3,-3.9e-3,0e-3,3.5e-3,10e-3,5.8e-3),
    Values(-00e3,11e3,25e3,47e3,53e3,75e3,90e3,126e3,175e3))
const US59 = Atmosphere{Metric}(
...
const US22E = Atmosphere{English}(Values(-3.5658e-3,0e-3),Values(-0e3,36.089e3))
const US25E = Atmosphere{English}(Values(-3.5658e-3,0e-3),Values(-0e3,35.332e3))
const US56E = Atmosphere{English}(
...
const US59E = Atmosphere{English}(
...
const US62E = Atmosphere{English}(
...
const US66E = Atmosphere{English}(
...
const US76E = Atmosphere{English}(
